...
abstract class Members implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Me\\Models\\Me\\Models\\Map\\MembersTableMap';
    ...
    /**
     * The value for the applianceid field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Me\Models\Me\Models\Base\Members object.
     */
    ...
    /**
     * Get the [applianceid] column value.
     *
     * @return int
     */
     ...
     * @return $this|\Me\Models\Me\Models\Members The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [applianceid] column.
     *
     * @param int $v new value
     * @return $this|\Me\Models\Me\Models\Members The current object (for fluent API support)
     */
    public function setApplianceid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->applianceid !== $v) {
            $this->applianceid = $v;
            $this->modifiedColumns[MembersTableMap::COL_APPLIANCEID] = true;
        }
    ...
    public function setServiceid($v)
    {
        ...
        if ($this->serviceid !== $v) {
            $this->serviceid = $v;
            $this->modifiedColumns[MembersTableMap::COL_SERVICEID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MembersTableMap::translateFieldName('Applianceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->applianceid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MembersTableMap::translateFieldName('Serviceid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MembersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Me\\Models\\Me\\Models\\Members'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MembersTableMap::COL_APPLIANCEID)) {
            $modifiedColumns[':p' . $index++]  = 'applianceId';
        }
        if ($this->isColumnModified(MembersTableMap::COL_SERVICEID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'applianceId':
                        $stmt->bindValue($identifier, $this->applianceid, PDO::PARAM_INT);
                        break;
                    case 'serviceId':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Me\Models\Me\Models\Members
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setApplianceid($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setServiceid($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Me\Models\Me\Models\Members The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MembersTableMap::COL_APPLIANCEID)) {
            $criteria->add(MembersTableMap::COL_APPLIANCEID, $this->applianceid);
        }
        if ($this->isColumnModified(MembersTableMap::COL_SERVICEID)) {
            $criteria->add(MembersTableMap::COL_SERVICEID, $this->serviceid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Me\Models\Me\Models\Members (or compatible) type.
    ...
    {
        $copyObj->setApplianceid($this->getApplianceid());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Me\Models\Me\Models\Members Clone of current object.
     * @throws PropelException
     */
