...
use Me\Models\Me\Models\Services;
use Me\Models\Me\Models\ServicesQuery;
...
class ServicesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Me.Models.Me.Models.Map.ServicesTableMap';
     ...
     */
    const OM_CLASS = '\\Me\\Models\\Me\\Models\\Services';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Me.Models.Me.Models.Services';
    ...
    /**
     * the column name for the portnum field
     */
    const COL_PORTNUM = 'services.portnum';

    /**
     * the column name for the servicename field
     */
    const COL_SERVICENAME = 'services.servicename';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Portnum', 'Servicename', ),
        self::TYPE_CAMELNAME     => array('id', 'portnum', 'servicename', ),
        self::TYPE_COLNAME       => array(ServicesTableMap::COL_ID, ServicesTableMap::COL_PORTNUM, ServicesTableMap::COL_SERVICENAME, ),
        self::TYPE_FIELDNAME     => array('id', 'portnum', 'servicename', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Portnum' => 1, 'Servicename' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'portnum' => 1, 'servicename' => 2, ),
        self::TYPE_COLNAME       => array(ServicesTableMap::COL_ID => 0, ServicesTableMap::COL_PORTNUM => 1, ServicesTableMap::COL_SERVICENAME => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'portnum' => 1, 'servicename' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Me\\Models\\Me\\Models\\Services');
        $this->setPackage('Me.Models.Me.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('portnum', 'Portnum', 'SMALLINT', true, 5, null);
        $this->addColumn('servicename', 'Servicename', 'VARCHAR', true, 32, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ServicesTableMap::COL_PORTNUM);
            $criteria->addSelectColumn(ServicesTableMap::COL_SERVICENAME);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.portnum');
            $criteria->addSelectColumn($alias . '.servicename');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Me\Models\Me\Models\Services) { // it's a model object
