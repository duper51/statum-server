...
use Me\Models\Me\Models\Members;
use Me\Models\Me\Models\MembersQuery;
...
class MembersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Me.Models.Me.Models.Map.MembersTableMap';
     ...
     */
    const OM_CLASS = '\\Me\\Models\\Me\\Models\\Members';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Me.Models.Me.Models.Members';
    ...
    /**
     * the column name for the applianceId field
     */
    const COL_APPLIANCEID = 'members.applianceId';

    /**
     * the column name for the serviceId field
     */
    const COL_SERVICEID = 'members.serviceId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Applianceid', 'Serviceid', ),
        self::TYPE_CAMELNAME     => array('id', 'applianceid', 'serviceid', ),
        self::TYPE_COLNAME       => array(MembersTableMap::COL_ID, MembersTableMap::COL_APPLIANCEID, MembersTableMap::COL_SERVICEID, ),
        self::TYPE_FIELDNAME     => array('id', 'applianceId', 'serviceId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Applianceid' => 1, 'Serviceid' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'applianceid' => 1, 'serviceid' => 2, ),
        self::TYPE_COLNAME       => array(MembersTableMap::COL_ID => 0, MembersTableMap::COL_APPLIANCEID => 1, MembersTableMap::COL_SERVICEID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'applianceId' => 1, 'serviceId' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Me\\Models\\Me\\Models\\Members');
        $this->setPackage('Me.Models.Me.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('applianceId', 'Applianceid', 'INTEGER', true, null, null);
        $this->addColumn('serviceId', 'Serviceid', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MembersTableMap::COL_APPLIANCEID);
            $criteria->addSelectColumn(MembersTableMap::COL_SERVICEID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.applianceId');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Me\Models\Me\Models\Members) { // it's a model object
